...
define(function (require) {
	...
	AIPlayer.prototype = {
		...
		seeCard: function (suggestion, card, answerer, _couldNotAnswer, player) {
			this.couldNotAnswer(suggestion, _couldNotAnswer);
			var pa = this.getPlayerAssumption(answerer);
			pa.addCertainHandCard(card);
			this.observeMove(suggestion, player, answerer, _couldNotAnswer);
		},
		...
		setAccusation: function () {
			return Promise.resolve(this.searchSpace.getAccusation());
		}
	};
	return AIPlayer;
});